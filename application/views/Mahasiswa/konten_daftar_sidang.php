	...
	<div class="box box-primary">
		...
		<form role="form">
			<div class="box-body">
				...
				<div class="form-group">
					<label for="exampleInputEmail1">Ruangan Sidang</label>
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Ruangan Sidang">
				</div>

				<div class="form-group">
					<label for="exampleInputFile">File Draft TA Final</label>
